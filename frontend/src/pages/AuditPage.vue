...
const eventOptions = [
  ...
  { value: 'openapi.log_analysis.queued', label: '日志分析排队' },
  { value: 'openapi.log_analysis.completed', label: '日志分析完成' },
  { value: 'openapi.log_analysis.failed', label: '日志分析失败' },
  { value: 'openapi.log_analysis.processing_failed', label: '日志后台分析失败' },
  { value: 'message.processed', label: '消息分析' },
  { value: 'message.processing_retried', label: '消息分析重试' },
